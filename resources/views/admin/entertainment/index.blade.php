...
@push('breadcrumbs')
<h1 class="mb-0 pb-0 display-4" id="title">List Entertainment</h1>
<nav class="breadcrumb-container d-inline-block" aria-label="breadcrumb">
    <ul class="breadcrumb pt-0">
        <li class="breadcrumb-item"><a href="#">Home</a></li>
        <li class="breadcrumb-item"><a href="{{ url('entertainment') }}">Entertainment</a></li>
    </ul>
</nav>
@endpush
...
<div class="row">
    ...
    <div class="col-xl-12 mb-6">
        <div class="card">
            <div class="card-body">
                @include('admin.entertainment.create')

                @include('admin.entertainment.edit')
            </div>
        </div>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="mb-5">
                            <table class="table table-hover nowrap" width="100%" id="tableEntertainment">
                                <thead>
                                    <tr>
                                        <th>No</th>
                                        <th>Nama</th>
...
<script>
    ...
    $(document).ready(function () {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (response.status == 1) {
                        let oTable = $('#tableEntertainment').dataTable();
                        oTable.fnDraw(false);
                        Swal.fire({
                            icon: 'success',
                            title: 'Berhasil',
                            text: 'Berhasil Menambah entertainment !',
                        });
                    } else if (response.status == 2) {
                        Toast.fire({
                            icon: 'error',
                            title: 'Gagal Menambah entertainment !'
                        })
                    } else if (response.status == 3) {
                        Toast.fire({
                            icon: 'warning',
                            title: 'entertainment Telah Tersedia !'
                        })
                    }
                },
                error: function (e) {
        ...
        $(this).on('click', '#button_delete', function (e) {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        type: "DELETE",
                        url: `{{ url('admin/entertainment') }}/${id}`,
                        data: {
                            _token: '{{csrf_token()}}'
                        },
                        dataType: "json",
                        success: function (response) {
                            if (response.status == 1) {
                                ...
                                Swal.fire({
                                    icon: 'success',
                                    title: 'Berhasil',
                                    text: 'Berhasil Menghapus entertainment !',
                                });
                            } else if (response.status == 2) {
                                Toast.fire({
                                    icon: 'error',
                                    title: 'Gagal Menghapus entertainment !'
                                })
                            }
                        },
                        error: function () {
        ...
        $(this).on('click', "#button_edit", function (e) {
            ...
            $.ajax({
                type: "get",
                url: `{{url('admin/entertainment')}}/${id}{{ '/edit' }}`,
                dataType: "json",
                success: function (response) {
            ...
            $(".modal-title").html("Ubah Data entertainment");
        });
        editData();
        function editData()
        {
                ...
                success: function (response) {
                    ...
                    if (response.status == 1) {
                        ...
                        Swal.fire({
                            icon: 'success',
                            title: 'Berhasil',
                            text: 'Berhasil Memperbaharui entertainment!',
                        });
                    } else if (response.status == 2) {
                        Toast.fire({
                            icon: 'error',
                            title: 'Gagal Memperbaharui entertainment !'
                        })
                    }
                },
                error: function (e) {
