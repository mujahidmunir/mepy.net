...
<div class="row">
    ...
    <div class="col-xl-12 mb-6">
        <div class="card">
            <div class="card-body">
                @include('admin.record.create')

                @include('admin.record.edit')
            </div>
        </div>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="mb-5">
                            <table class="table table-hover nowrap" width="100%" id="tableRecord">
                                <thead>
                                    <tr>
                                        <th>No</th>
                                        <th>Nama</th>
...
<script>
    ...
    $(document).ready(function () {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (response.status == 1) {
                        let oTable = $('#tableRecord').dataTable();
                        oTable.fnDraw(false);
                        Swal.fire({
                            icon: 'success',
                            title: 'Berhasil',
                            text: 'Berhasil Menambah Record !',
                        });
                    } else if (response.status == 2) {
                        Toast.fire({
                            icon: 'error',
                            title: 'Gagal Menambah Record !'
                        })
                    } else if (response.status == 3) {
                        Toast.fire({
                            icon: 'warning',
                            title: 'Record Telah Tersedia !'
                        })
                    }
                },
                error: function (e) {
                        ...
                        success: function (response) {
                            if (response.status == 1) {
                                ...
                                Swal.fire({
                                    icon: 'success',
                                    title: 'Berhasil',
                                    text: 'Berhasil Menghapus Record !',
                                });
                            } else if (response.status == 2) {
                                Toast.fire({
                                    icon: 'error',
                                    title: 'Gagal Menghapus Record !'
                                })
                            }
                        },
                        error: function () {
        ...
        $(this).on('click', "#button_edit", function (e) {
            ...
            $(".modal-title").html("Ubah Data Record");
        });
        editData();
        function editData()
        {
                ...
                success: function (response) {
                    ...
                    if (response.status == 1) {
                        ...
                        Swal.fire({
                            icon: 'success',
                            title: 'Berhasil',
                            text: 'Berhasil Memperbaharui Record!',
                        });
                    } else if (response.status == 2) {
                        Toast.fire({
                            icon: 'error',
                            title: 'Gagal Memperbaharui Record !'
                        })
                    }
                },
                error: function (e) {
