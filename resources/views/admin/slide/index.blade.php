...
@push('breadcrumbs')
<h1 class="mb-0 pb-0 display-4" id="title">List Slide</h1>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="mb-5">
                            <table class="table table-hover nowrap" width="100%" id="tableSlide">
                                <thead>
                                    <tr>
                                        <th>No</th>
                                        <th>Judul</th>
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (response.status == 1) {
                        let oTable = $('#tableSlide').dataTable();
                        oTable.fnDraw(false);
                        Swal.fire({
                            icon: 'success',
                            title: 'Berhasil',
                            text: 'Berhasil Menambah slide !',
                        });
                    } else if (response.status == 2) {
                        Toast.fire({
                            icon: 'error',
                            title: 'Gagal Menambah slide !'
                        })
                    } else if (response.status == 3) {
                        Toast.fire({
                            icon: 'warning',
                            title: 'slide Telah Tersedia !'
                        })
                    }
                },
                error: function (e) {
                        ...
                        success: function (response) {
                            if (response.status == 1) {
                                ...
                                Swal.fire({
                                    icon: 'success',
                                    title: 'Berhasil',
                                    text: 'Berhasil Menghapus slide !',
                                });
                            } else if (response.status == 2) {
                                Toast.fire({
                                    icon: 'error',
                                    title: 'Gagal Menghapus slide !'
                                })
                            }
                        },
                        error: function () {
        ...
        $(this).on('click', "#button_edit", function (e) {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    $("#page_edit").val(response.page);
                    $("#preview_img_edit").attr('src',
                        `{{ asset('assets/images/slide/') }}/${response.image}`
                        );
            ...
            $(".modal-title").html("Ubah Data slide");
        });
        editData();
        function editData()
        {
                ...
                success: function (response) {
                    ...
                    if (response.status == 1) {
                        ...
                        Swal.fire({
                            icon: 'success',
                            title: 'Berhasil',
                            text: 'Berhasil Memperbaharui slide!',
                        });
                    } else if (response.status == 2) {
                        Toast.fire({
                            icon: 'error',
                            title: 'Gagal Memperbaharui slide !'
                        })
                    }
                },
                error: function (e) {
