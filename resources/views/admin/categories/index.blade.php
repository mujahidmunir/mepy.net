...
@push('breadcrumbs')
<h1 class="mb-0 pb-0 display-4" id="title">List Kategori</h1>
<nav class="breadcrumb-container d-inline-block" aria-label="breadcrumb">
    <ul class="breadcrumb pt-0">
        <li class="breadcrumb-item"><a href="#">Home</a></li>
        <li class="breadcrumb-item"><a href="{{ url('categories') }}">Kategori</a></li>
    </ul>
</nav>
@endpush
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="mb-5">
                            <table class="table table-hover nowrap" width="100%" id="tableCategories">
                                <thead>
                                    <tr>
                                        <th>No</th>
                                        <th>Nama</th>
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (response.status == 1) {
                        let oTable = $('#tableCategories').dataTable();
                        oTable.fnDraw(false);
                        Swal.fire({
                            icon: 'success',
                            title: 'Berhasil',
                ...
                success: function (response) {
                    ...
                    if (response.status == 1) {
                        ...
                        Swal.fire({
                            icon: 'success',
                            title: 'Berhasil',
                            text: 'Berhasil Memperbaharui Kategori!',
                        });
                    } else if (response.status == 2) {
                        Toast.fire({
                            icon: 'error',
